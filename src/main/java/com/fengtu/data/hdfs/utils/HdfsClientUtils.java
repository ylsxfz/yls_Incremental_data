package com.fengtu.data.hdfs.utils;
...
public class HdfsClientUtils {
	 ...
	 */
	public static void copyFromLocalFile(String localPath, String hdfsPath,boolean isDeleteSourceFile) throws Exception {
		if (isDeleteSourceFile){
			fs.moveFromLocalFile(new Path(localPath), new Path(hdfsPath));
		}else {
